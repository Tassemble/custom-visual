...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<?php if ( has_post_thumbnail() ) { ?>
		<div style="position: relative;z-index: 10;left: 249px;top: 70px;font: italic small-caps bold 30px Arial;color: red;">
		<?php 
			$score = get_post_meta( get_the_ID(), 'average_score', true );
